...
#ifndef _ZPERFORMANCE_H_
#define _ZPERFORMANCE_H_

#define MY_PROFILE_ID                       0x7777  //Home Control, Lighting
#define MY_PROFILE_ID_MSB                   0x77
#define MY_PROFILE_ID_LSB                   0x77

#define PERFORMANCE_SENSOR_DEV_ID      0x7770   //Temperature Sensor (MCHP)
#define PERFORMANCE_SENSOR_DEV_ID_MSB  0x77
#define PERFORMANCE_SENSOR_DEV_ID_LSB  0x70
#define PERFORMANCE_SENSOR_DEV_VER     0x00
...
#define Performance_CLUSTER     0x77    //Teste de performance
...
//------------------------------------------------------------------------------
// Performance Cluster : Teste de performance
#define Performance_PduOStr                     0x7777  //Teste de performance
#define Performance_PduOStr_DATATYPE            APL_FRAME_DATA_TYPE_OSTRING
