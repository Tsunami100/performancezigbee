                            ...
                            else
                            {
                                if (apsStatus.indirectMessages[i]->flags.bits.bSendMessage)
                                {
                                    ...
                                    if (currentBindingRecord.shortAddr.Val == macPIB.macShortAddress.Val)
                                    {
                                        ...
                                        params.APSDE_DATA_indication.ProfileId.Val= MY_PROFILE_ID;  // TODO Binding should probably have this...
                                    ...
                                    {   // The destination is for someone else.
                                        ...
                                        //apsConfirmationHandles[j]->SrcEndpoint = unknown
...
BufferAPLMessage:
            ...
            case APSME_BIND_request:
                    ...
                    // associated.  However, it doesn't allow us to unbind...
                    {
                        ...
                        if (LookupNodeByLongAddr( &params.APSME_BIND_request.DstAddr ) == INVALID_NEIGHBOR_KEY)
                        {
                            params.APSME_BIND_confirm.Status = BIND_ILLEGAL_DEVICE;
                            return APSME_BIND_confirm;
                        }
                     ...
                     SHORT_ADDR destAddr, BYTE destEP )
{
    ...
    // Binding source and dest EPs on coordinator is not allowed.
    if ((srcAddr.Val == 0) && (destAddr.Val == 0))
        return BIND_ILLEGAL_REQUEST;
